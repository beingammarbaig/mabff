...
export default function Menu(props) {
  return (
    <>
      <div className="" style={{ menuCss }}>
        {/* Navbar */}
        <nav className="menuCss navbar navbar-expand-lg navbar-dark">
        ...
        <div
          class="jumbotron jumbotron-fluid text-center text-white"
          style={{ backgroundColor: "red" }}
        >
          <div class="container">
            <h1 class="">Our Menu</h1>
            <p class="">Explore our delicious offering.</p>
          </div>
        </div>

        {/* Menu Sections */}
        <div class="x mx-4">
          <section className="bg-warning p-3 my-3">
            <h2 class="text-center pb-4">Appetizers</h2>
            <div class="row">
              {props.menu.map((x) => {
                return (
                  <>
          ...
          <section className="bg-warning p-3 my-3">
            <h2 class="text-center pb-4">Main Course</h2>
            <div class="row">
              {props.menu.map((x) => {
                return (
                  <>
          ...
          <section className="bg-warning p-3 my-3">
            <h2 class="text-center pb-4">Dessert</h2>
            <div class="row">
              {props.menu.map((x) => {
                return (
                  <>
