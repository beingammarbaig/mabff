...
export default function Reservation() {
  ...
  const [state, setState] = useState([{ date: " ", time: " ", partySize: " ", name: " ", email: " ", phone: " " }]);
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(json);
    setState({ date: " ", time: " ", partySize: " ", name: " ", email: " ", phone: " " });
    if (json.success){
      setShowModal(true);
  ...
  return (
    ...
    <div class="jumbotron jumbotron-fluid text-center text-white" style={{backgroundColor: "red"}}>
        <div class="container">
            ...
            <p class="">Book a table and enjoy a wonderful dining experience.</p>
        </div>
    </div>
...
<br/>
                ...
                <form onSubmit={handleSubmit}>
                    <div class="form-group">
                        ...
                        <input onChange={changeon}
                  name="date"
                  value={state.date} type="date" class="form-control" id="date" required/>
                    </div>
                    <div class="form-group">
                        <label for="time">Time</label>
                        <input onChange={changeon}
                  name="time"
                  value={state.time} type="time" class="form-control" id="time" required/>
                    </div>
                    <div class="form-group">
                        <label for="party-size">Party Size</label>
                        <input onChange={changeon}
                  name="partySize"
                  value={state.partySize} type="number" class="form-control" id="party-size" min="1" required/>
                    </div>
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input onChange={changeon}
                  name="name"
                  value={state.name} type="text" class="form-control" id="name" required/>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input onChange={changeon}
                  name="email"
                  value={state.email} type="email" class="form-control" id="email" required/>
                    </div>
                    <div class="form-group">
                        <label for="phone">Phone</label>
                        <input onChange={changeon}
                  name="phone"
                  value={state.phone} type="tel" class="form-control" id="phone" required/>
                    </div>
    ...
    <footer className="footer p-3 mt-5">
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <a href="https://play.google.com/store/games?hl=en&gl=US" class="download-button text-center">
